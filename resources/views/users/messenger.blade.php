    ...
    <div class="card-body">
      ...
      <hr class="my-4">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                {!! Form::text('bale_bot_token', null, ['class' => 'form-control' . ($errors->has('bale_bot_token') ? ' is-invalid' : ''), 'placeholder' => __('users.placeholder.bale_bot_token'), 'required']) !!}
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                {!! Form::text('bale_channel_chat_id', null, ['class' => 'form-control' . ($errors->has('bale_channel_chat_id') ? ' is-invalid' : ''), 'placeholder' => __('users.placeholder.bale_channel_chat_id'), 'required']) !!}
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                {!! Form::text('telegram_bot_token', null, ['class' => 'form-control' . ($errors->has('telegram_bot_token') ? ' is-invalid' : ''), 'placeholder' => __('users.placeholder.telegram_bot_token'), 'required']) !!}
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                {!! Form::text('telegram_channel_chat_id', null, ['class' => 'form-control' . ($errors->has('telegram_channel_chat_id') ? ' is-invalid' : ''), 'placeholder' => __('users.placeholder.telegram_channel_chat_id'), 'required']) !!}
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                {!! Form::text('eitaa_bot_token', null, ['class' => 'form-control' . ($errors->has('eitaa_bot_token') ? ' is-invalid' : ''), 'placeholder' => __('users.placeholder.eitaa_bot_token'), 'required']) !!}
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                {!! Form::text('eitaa_channel_chat_id', null, ['class' => 'form-control' . ($errors->has('eitaa_channel_chat_id') ? ' is-invalid' : ''), 'placeholder' => __('users.placeholder.eitaa_channel_chat_id'), 'required']) !!}
